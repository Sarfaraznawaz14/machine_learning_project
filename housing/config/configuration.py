...
class Configuration:
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        try:
            ...
            logging.info(f"Data_ingetion_config: {data_ingestion_config}")
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        try:
            ...
            report_file_name = os.path.join(data_validation_artifact_dir,
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            preprocessed_object_file_path = os.path.join(data_transformation_artifact_dir,
                                                 ...
                                                 data_transformation_info[DATA_TRANSFORMATION_PREPROCESSING_OBJECT_FILE_NAME_KEY])
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        try:
            ...
            trained_model_file_path = os.path.join(model_trainer_config_info,
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        try:
            ...
            model_evaluation_config_response = ModelEvaluationConfig(model_evaluation_file_path= model_evaluation_file_path,
                                                            time_stamp = time_stamp)
            logging.info(f"Model_evaluation_config: {model_evaluation_config_response}")
            return model_evaluation_config_response
